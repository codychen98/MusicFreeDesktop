...
const config: ForgeConfig = {
    ...
    plugins: [
        new WebpackPlugin({
            ...
            renderer: {
                /**
         * Must match BrowserWindow `webPreferences.nodeIntegration` (true in this app).
         * If omitted, Forge uses target "web" and bundled deps can throw __dirname is not defined
         * in the packaged renderer even though the window has node integration at runtime.
         */
